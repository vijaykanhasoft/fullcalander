...
//                console.log(view);
                var dayview = '<th class="fc-day-header ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + '">';
                dayview += "<span style='font-family:Helvetica,HelveticaNeue,Arial,sans-serif;background-color: #B2DCF7;float: left;font-size: 70px;height: 80px;color:#666;line-height: 80px;position: relative;width: 100px;'>" + htmlEscape(date.format('DD')) + "</span>" + " " + "<span style='color: #666666;float: left;font-size: 33px;line-height: 80px;position: relative;margin-left: 15px;'>" + htmlEscape(date.format(this.colHeadFormat)) + "</span><span id='pendingspan' style='color: #666666;float: left;font-style: italic;line-height: 80px; margin-left: 50px;'>You have <span class='sel todaysevent' style='background-color: #FF3333;border-radius: 50%;color: #FFFFFF;display: inline-block;line-height: normal;margin: 30px 7px;padding: 2px 9px 1px 6px;'></span>events / tasks due for today!</span>";
                dayview += '</th>';

                //  alert("ddddddd dddd"+$('.fc-event-container a.fc-time-grid-event').length);
                return dayview;
            } else {
                return '' +
    ...
    DayGrid.mixin({
        ...
        renderFgSegs: function(segs) {
            ...
            this.rowEls.each(function(i, rowNode) {
               // debugger;
               // console.log(rowStructs[i].tbodyEl)
        ...
        fgSegHtml: function(seg, disableResizing) {
            ...
            classes.unshift('fc-time-grid-event', 'fc-h-event');
        ...
        fgSegHtml: function(seg, disableResizing) {
            ...
            return '<a class="' + classes.join(' ') + '"' +
                    ...
                    (timeText ?
                            ...
                            ' style="' + strickout_class + '">' +
                            '<span>' + htmlEscape(timeText) + '</span>' +
                            '</div>' :
                            ''
                            ) +
                    (event.title ?
                            '<div class="fc-title" style="' + strickout_class + '">' +
